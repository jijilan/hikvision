...
public class Playback extends Thread {
    ...
    public static void main(String[] args) {
        ...
        Playback playback = new Playback(3, 0L, drvice, Utils.getDvrTime("2019-07-6 00:00:00"), Utils.getDvrTime("2019-07-6 00:00:15"), DeviceEnums.playUrl.getValue() + "123.mp4");
        playback.start();
    }
}
