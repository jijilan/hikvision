...
public interface HCNetSDK extends Library {
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(Utils.getLoadLibraryUrl("libhcnetsdk.so"),
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
interface PlayCtrl extends Library {
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(Utils.getLoadLibraryUrl("libPlayCtrl.so"),
            PlayCtrl.class);
...
interface GDI32 extends W32API {
    GDI32 INSTANCE = (GDI32) Native.loadLibrary(Utils.getLoadLibraryUrl("gdi32"), GDI32.class, DEFAULT_OPTIONS);
...
interface USER32 extends W32API {
    USER32 INSTANCE = (USER32) Native.loadLibrary(Utils.getLoadLibraryUrl("user32"), USER32.class, DEFAULT_OPTIONS);
